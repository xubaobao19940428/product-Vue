<template>
    <div class="app-container">
        ...
        <edit-dialog :dialogVisible="dialog.show" bannerType="4" :countryList="countryList" :propParam="dialog.param" @close="closeEditDialog" @confirm="confirmEditItem"></edit-dialog>
    </div>
</template>
<script>
