  ...
  <div class="app-container">
      ...
      <div class="main-content-wrapper">
          <el-table
              ...
              <el-table-column label="名称" align="center" prop="name" min-width="100px"></el-table-column>
              <el-table-column
                  label="图片"
                  align="center"
                  min-width="100px">
              ...
              <el-table-column label="跳转类型" align="center" width="120px">
                  <template slot-scope="scope">{{ getNameByKey('typeList', scope.row.type) }}</template>
              </el-table-column>
              <el-table-column prop="url" min-width="150px" label="跳转链接" header-align="center"></el-table-column>
              <el-table-column label="弹屏状态" align="center" width="120px">
                  <template slot-scope="scope">{{ getNameByKey('bombStatusList', scope.row.bombStatus) }}</template>
              </el-table-column>
              <el-table-column label="弹窗效期" min-width="170px" align="center">
                  <template slot-scope="scope">
