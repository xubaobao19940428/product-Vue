    ...
    <el-dialog
        ...
        <div style="height: 100%; width: 100%">
            <el-form :rules="adDialogRules"
                ...
                <el-form-item label="曝光人群：" prop="activeCrowdType" required v-show="type == 4 || type == 6">
                    <el-radio-group v-model="param.activeCrowdType" placeholder="请选择" size="medium">
                        <el-radio v-for="item in activeCrowdTypeArray" :key="item.key"
                            :label="item.key"
                        >{{ item.name }}</el-radio>
                    </el-radio-group>
                </el-form-item>
