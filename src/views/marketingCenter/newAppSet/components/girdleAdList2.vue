    ...
    <div class="app-container">
        <el-form inline>
            ...
            <el-form-item>
                <el-button size="medium"
                           type="primary"
                           icon="el-icon-plus"
                           v-if="hasPermission('BTN_PLATFORM_AD_ADD')"
            ...
            <el-form-item>
                <el-button size="medium"
                           type="danger"
                           icon="el-icon-delete"
                           v-if="hasPermission('BTN_PLATFORM_AD_DELETE')"
                           @click="toDeleteAll()">批量删除</el-button>
            </el-form-item>
        </el-form>
        <bg-set-list  dialogType="6" :countryList="countryList" :countryCode="searchParam.countryCode"></bg-set-list>
        <div class="main-content-wrapper">
            <el-table
                ...
                <el-table-column label="广告位图片" align="center" min-width="100px">
                ...
                <el-table-column label="排序"
                    ...
                    <template slot-scope="scope">
                        ...
                        <el-button
                            type="primary"
                            plain
                            v-if="hasPermission('BTN_PLATFORM_AD_SORT')"
                ...
                <el-table-column fixed="right"
                    ...
                    <template slot-scope="scope">
                        <el-button type="text" size="mini"
                                   v-if="hasPermission('BTN_PLATFORM_AD_EDIT')"
                                   @click="showEditDialog('edit', scope.row)">编辑</el-button>
                        <el-button size="mini" type="text"
                                   v-if="hasPermission('BTN_PLATFORM_AD_COPY')"
        ...
        <edit-dialog :dialogVisible="dialog.show" dialogTitle="编辑广告Card" :urlType="urlType" :appPageEnum="appPageEnum" :countryList="countryList" :type="searchParam.type" :propParam="dialog.param" @close="closeEditDialog" @confirm="confirmEditItem"></edit-dialog>
    </div>
</template>
<script>
