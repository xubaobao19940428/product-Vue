<template>
    <div class="activity-sku-wrapper">
        ...
        <el-table border
            ...
            <el-table-column label="参考活动价(RM)" min-width="130" align="center">
                <template slot-scope="scope">
            ...
            <el-table-column :label="countryCode == 'TH' ? '总佣金率%' : '佣金率%'" min-width="100" align="center">
                <template slot-scope="scope">
            ...
            <el-table-column min-width="130px" align="center">
                <template slot="header" slot-scope="scope">
                    <span class="required">*</span>{{ countryCode == 'TH' ? '活动总佣金率%' : '活动佣金率%' }} 
                </template>
                <template slot-scope="scope">
                    <el-input-number 
                        v-if="propType == 'edit'" 
                ...
                return new Promise((resolve) => {
                    ...
                    if (canSubmit) {
                        ...
                        for (let i = 0; i < skuList.length; i++) {
                            ...
                            skuList[i].activeCommissionRate = skuList[i].activeCommissionRate.toString()
                        }
                        resolve(skuList)
                    } else {
