  ...
  <div class="task-list">
    ...
    <el-form ref="directMailFilter" inline label-width="80px" :model="queryData">
      ...
      <span>
        ...
        >
          <el-select v-model="queryData.exportType" placeholder="请选择">
            <el-option
      ...
      <el-form-item class="filter-item" label="提交人：">
        <el-input v-model="queryData.buyerName" clearable placeholder="请输入" size="medium" style="width: 200px"></el-input>
      </el-form-item>
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column label="任务类型" width="130" align="center">
        <template slot-scope="scope">{{scope.row.exportType == 3?'出库单导出':(scope.row.exportType == 4?'入库单导出':'异常库存导出')}}</template>
      </el-table-column>
    ...
    getPurEnsureImportPage() {
      ...
      if (this.queryData.timeChose === "1") {
        Object.assign(params, {
          ...
          buyerName: this.queryData.buyerName,
