...
<script>
    export default {
        data () {
            return{
                dateRange: this.timeMark === 'add' || this.timeMark === 'returns' || this.timeMark === 'cancles' ?[moment('2020-04-18').format('YYYY-MM-DD'), moment().subtract('days', 1).format('YYYY-MM-DD')]:[moment().subtract('days', 30).format('YYYY-MM-DD'), moment().subtract('days', 1).format('YYYY-MM-DD')],
                dateRangeTwo: [moment().subtract('days', 30).format('YYYY-MM-DD HH:mm:ss'), moment().subtract('days', 1).format('YYYY-MM-DD HH:mm:ss')],
                dateRangeTimeStamp: this.timeMark === 'add' || this.timeMark === 'returns' || this.timeMark === 'cancles' ?[moment('2020-04-18').format('YYYY-MM-DD').valueOf(), moment().subtract('days', 1).format('YYYY-MM-DD').valueOf()]:[moment(moment().subtract('days', 30).format('YYYY-MM-DD')).valueOf(), moment(moment().subtract('days', 1).format('YYYY-MM-DD')).valueOf()],
                pickerOptions: {
                    // disabledDate(time) {
        ...
        methods: {
            ...
            confirm () {
                ...
                if (this.timeMark === 'miss'){
                    console.log('====>')
                    this.$emit('on-confirms',this.timeMark, this.dateRangeTwo, this.dateRangeTimeStamp)
                } else {
                    this.$emit('on-confirm',this.timeMark, this.dateRange, this.dateRangeTimeStamp)
                }
            },
            handelDateChange(data){
                ...
                this.dateRangeTimeStamp[0] = moment(startTime, 'YYYY-MM-DD HH:mm:ss').valueOf()
                this.dateRangeTimeStamp[1] = moment(endTime, 'YYYY-MM-DD HH:mm:ss').valueOf()
                console.log(this.dateRangeTimeStamp)
            },
